...
public class Methods {
	...
	public static String substituteAll(String source, char target, String replacement) {
		...
		{
			int target_loc = source.indexOf(target);
			result = result + source.substring(0, target_loc) + replacement;
			source = source.substring(target_loc+1);
	...
	/**
	 * Return the mean of a given int array
	 * 
	 * @param nums the array that contains the numbers that will be avereged
	 * @return a double that contains the mean of the array
	 */
